...
complete -c pw-midiplay -s d -l dsd -d 'DSD mode.  FILE is a DSF file'
...
complete -c pw-midiplay -s P -l properties -d 'Set extra stream properties as a JSON object'
...
complete -c pw-midiplay -l format -d 'The sample format to use.  One of: u8, s8, s16 (default), s24, s32, f32, f64'
