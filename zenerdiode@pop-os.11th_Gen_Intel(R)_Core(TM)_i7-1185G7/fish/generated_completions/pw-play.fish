...
complete -c pw-play -s d -l dsd -d 'DSD mode.  FILE is a DSF file'
...
complete -c pw-play -s P -l properties -d 'Set extra stream properties as a JSON object'
...
complete -c pw-play -l format -d 'The sample format to use.  One of: u8, s8, s16 (default), s24, s32, f32, f64'
